...
To manage this resource, see AWS Proton Resource: arn:aws:proton:ap-northeast-1:443437525071:service/loadbalanced-ecs-ec2-svc/service-instance/loadbalanced-ecs-ec2-svc
