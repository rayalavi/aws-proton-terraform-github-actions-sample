...
To manage this resource, see AWS Proton Resource: arn:aws:proton:ap-northeast-1:443437525071:service/worker-ecs-fargate-sqs-svc/service-instance/worker-ecs-fargate-sqs-svc
